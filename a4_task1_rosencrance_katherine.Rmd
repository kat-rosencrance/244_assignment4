...
oil_spills %>% st_as_sf(oil_spills, coords=c("longitude","latitude"), crs = 3857)

st_crs(oil_spills) <- 3857

### make oil spills sf CRS EPSG 3857 so they match
...
ggplot(data = county_oil_count_sf) +
  geom_sf(aes(fill = n_records), color = "gold1", size = 0.1) +
